...
def main():
		...
		str_domain += "\nACTION: move_right(x:agent)
		str_domain += "PRECONDITIONS:\n"
		str_domain += "( agent_at(x) = 1 )\n"
		str_domain += "EFFECTS:\n"
		str_domain += "( agent_at(x) + 1 )\n"
		
		str_domain += "\nACTION: move_left(x:agent)\n"
		str_domain += "TYPE: memory\n"
		str_domain += "PRECONDITIONS:\n"
		str_domain += "( peeking(x) = 2 )\n"
		str_domain += "EFFECTS:\n"
		str_domain += "( peeking(x) - 1 )\n"

		str_domain += "\nACTION: sharing_truth(x:agent,y:agent)\n"
		str_domain += "TYPE: memory\n"
		str_domain += "PRECONDITIONS:\n"
		str_domain += "( face(y) = 0 )\n"
		str_domain += "EFFECTS:\n"
